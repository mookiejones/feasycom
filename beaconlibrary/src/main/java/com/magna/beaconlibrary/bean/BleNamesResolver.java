...
public class BleNamesResolver {
    ...
    public BleNamesResolver() {
    }

    public static String resolveServiceName(String uuid) {
        String var1 = (String) mServices.get(uuid);
        if (var1 == null) {
            var1 = "Unknown";
        }
    ...
    public static String resolveValueTypeDescription(int format) {
        Integer var1 = format;
        return (String) mValueFormats.get(var1, "Unknown Format");
    }

    public static String resolveCharacteristicName(String uuid) {
        String var1 = (String) mCharacteristics.get(uuid);
        if (var1 == null) {
            var1 = "Unknown";
        }
    ...
    public static String resolveUuid(String uuid) {
        ...
        if (var1 != null) {
            ...
            var1 = (String) mCharacteristics.get(uuid);
            if (var1 != null) {
                return "Characteristic: " + var1;
            } else {
                var1 = "Unknown UUID";
                return var1;
            }
    ...
    public static String resolveAppearance(int key) {
        Integer var1 = key;
        return (String) mAppearance.get(var1, "Unknown Appearance");
    }

    public static String resolveHeartRateSensorLocation(int key) {
        Integer var1 = key;
        return (String) mHeartRateSensorLocation.get(var1, "Other");
    }
