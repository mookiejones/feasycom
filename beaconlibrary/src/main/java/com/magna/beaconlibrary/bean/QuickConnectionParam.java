...
public class QuickConnectionParam {
    ...
    public static final class Builder {
        ...
        public QuickConnectionParam.Builder setmName(String mName) {
            if ("".equals(mName)) {
                mName = null;
            }
        ...
        public QuickConnectionParam.Builder setmMac(String mMac) {
            if ("".equals(mMac)) {
                mMac = null;
            }
        ...
        public QuickConnectionParam.Builder setmActivity(Activity mActivity) {
            this.mActivity = mActivity;
            return this;
        }

        public QuickConnectionParam.Builder setmData(String mData) {
            if ("".equals(mData)) {
                mData = null;
            }
