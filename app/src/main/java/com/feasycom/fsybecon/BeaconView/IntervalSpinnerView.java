...
public class IntervalSpinnerView extends LinearLayout {
    ...
    private int intervalParameter = 0;
    private FscBeaconApi fscBeaconApi= FscBeaconApiImp.getInstance();
    private String intervalList[] = {"100","152","211","318","417","546","760","852","1022","1285","2000"};
    ...
    public void intervalSelect(View v, int id) {
        ...
        if(isModule_BP109 == true && id != 2){
            Log.i("interval", "a dialog need to jump out");
            tipsDialog.show();
            return;
        }
        setBlack();
