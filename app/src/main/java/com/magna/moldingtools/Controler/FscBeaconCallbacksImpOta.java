...
import com.magna.moldingtools.Activity.UpgradeActivity;
...
//                    }, 3000);
            ...
            activityWeakReference.get().runOnUiThread(() -> activityWeakReference.get().otaProgress.setProgress(percentage));
        }
    }
