package com.magna.moldingtools.service;
...
public class OTASPPService extends Service {
    ...
    public byte[] a;
    private com.feasycom.util.b c = new   b();
    ...
    private int e() throws IOException {
        while (this.v) {
            ...
            if (this.J >= 100) {
                this.J = 100;
                this.y.postDelayed(() -> OTASPPService.this.s.otaProgressUpdate(OTASPPService.this.J, 10086), 1000L);
                this.z = false;
            }

            (new Thread(() -> OTASPPService.this.s.otaProgressUpdate(OTASPPService.this.J, 121))).start();
            if (this.q > 1024) {
                this.q = 1024;
            }
